...
CREATE TABLE task_notify_gru_cf(
 ...
 level_notification_email VARCHAR(255) DEFAULT '' NOT NULL,
  ...
  status_text_agent VARCHAR(255) DEFAULT '' NOT NULL,
 message_agent VARCHAR(255) DEFAULT '' NOT NULL,
 level_notification_agent VARCHAR(255) DEFAULT '' NOT NULL,
  is_active_onglet_agent SMALLINT NOT NULL DEFAULT 0,


 id_ressource_record_sms INT DEFAULT NULL,
 phone_sms VARCHAR(255) DEFAULT '' NOT NULL,
