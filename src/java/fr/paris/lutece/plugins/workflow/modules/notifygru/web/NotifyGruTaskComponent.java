...
public class NotifyGruTaskComponent extends NoFormTaskComponent
{
    ...
    public String doSaveConfig( HttpServletRequest request, Locale locale, ITask task )
    {
        ...
        String strSenderName_ongle1 = request.getParameter( NotifyGruConstants.PARAMETER_SENDER_NAME_ONGLE1 );
        String strSenderName_ongle3 = request.getParameter( NotifyGruConstants.PARAMETER_SENDER_NAME_ONGLE3 );
        String strSubject_ongle1 = request.getParameter( NotifyGruConstants.PARAMETER_SUBJECT_ONGLE1 );
        String strSubject_ongle3 = request.getParameter( NotifyGruConstants.PARAMETER_SUBJECT_ONGLE3 );
        String strMessage_ongle1 = request.getParameter( NotifyGruConstants.PARAMETER_MESSAGE_ONGLE1 );
        String strMessage_ongle3 = request.getParameter( NotifyGruConstants.PARAMETER_MESSAGE_ONGLE3 );
        String strIdDirectory_ongle1 = request.getParameter( NotifyGruConstants.PARAMETER_ID_DIRECTORY_ONGLE1 );
        String strIdDirectory_ongle3 = request.getParameter( NotifyGruConstants.PARAMETER_ID_DIRECTORY_ONGLE3 );
        String strPositionEntryDirectorySms = request.getParameter( NotifyGruConstants.PARAMETER_POSITION_ENTRY_GRU_SMS );
        int nPositionEntryDirectorySms = WorkflowUtils.convertStringToInt( strPositionEntryDirectorySms );
        String strPositionEntryDirectoryEmail = request.getParameter( NotifyGruConstants.PARAMETER_POSITION_ENTRY_GRU_EMAIL );
    ...
    public String getDisplayConfigForm( HttpServletRequest request, Locale locale, ITask task )
    {
        ...
        model.put( NotifyGruConstants.MARK_LIST_ENTRIES_EMAIL_SMS,
            _notifyDirectoryService.getListEntriesEmailSMS( task.getId(  ), locale ) );
        model.put( NotifyGruConstants.MARK_LIST_ENTRIES_FREEMARKER,
            _notifyDirectoryService.getListEntriesFreemarker( task.getId(  ) ) );
        model.put( NotifyGruConstants.MARK_GRU_LIST, _notifyDirectoryService.getListDirectories(  ) );
        ...
        model.put( NotifyGruConstants.MARK_TASKS_LIST, _notifyDirectoryService.getListBelowTasks( task, locale ) );
